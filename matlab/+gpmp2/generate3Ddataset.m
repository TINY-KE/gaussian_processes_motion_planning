...
%     [dataset.map, dataset.corner_idx] = add_obstacle([130 40 95], [60, 5, 190], dataset.map, dataset.corner_idx);   
    ...
    %zhjd
    [dataset.map, dataset.corner_idx] = add_obstacle([150 10 10], [10, 10, 10], dataset.map, dataset.corner_idx);
    % [dataset.map, dataset.corner_idx] = add_obstacle([250 140 90], [60, 100, 5], dataset.map, dataset.corner_idx);
    [dataset.map, dataset.corner_idx] = add_obstacle([10 10 150], [10, 10, 10], dataset.map, dataset.corner_idx);
% no such dataset
else
...
half_size_row = floor((size(1)-1)/2);  %position
